...
export const BackupHistoryPanel: React.FC<BackupHistoryPanelProps> = ({
  ...
  const newestFullBackupKey = backups.find(
    (backup) => !backup.scope || backup.scope === "full",
  )?.key;
  ...
  const handleRestore = (backup: BackupDTO) => {
      ...
      >
        <div>
          <h2 className="form-title" style={{ margin: 0 }}>
            ...
            R2 云端历史备份记录 ({backups.length} 个备份，共{" "}
          ...
          <table className="player-table">
            ...
            <tbody>
              {backups.map((bk) => {
                ...
                const canRestore =
                  bk.restoreSupported ?? (!bk.scope || bk.scope === "full");
                    ...
                    <td>
                      <span
                        style={{
                          ...
                          padding: "2px 8px",
                          borderRadius: "4px",
                          background: isGzip ? "#ecfdf5" : "#f3f4f6",
                          color: isGzip ? "#047857" : "#374151",
                        }}
                      >
                        {bk.formatVersion
                          ? `V${bk.formatVersion}`
                    ...
                    <td>
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={
                            !canRestore || isRestoring !== null || isBackingUp
                          }
                          title={
                            canRestore
                              ? bk.scope === "module"
                        ...
                        <button
                          ...
                          disabled={
                            isNewest || isRestoring !== null || isBackingUp
                          }
                          title={
                            isNewest
                              ? "最新备份已被系统永久保护，禁止删除"
